...
class VoiceManager:
    ...
    def __init__(
        ...
        openai_voice_mapping: Optional[str] = None,
    ):
        """
        ...
        if openai_voice_mapping:
            try:
                ...
                print(
                    f"Warning: Failed to parse OPENAI_VOICE_MAPPING: {e}. Using default mapping."
                )
    ...
    def get_voice_path(
        self, voice_name: str, is_openai_voice: bool = False
    ) -> Optional[str]:
        """
    ...
    def load_voice_audio(
        self, voice_name: str, is_openai_voice: bool = False, target_sr: int = 24000
    ) -> Optional[np.ndarray]:
        """
